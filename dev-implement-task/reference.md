...
| Two agents, same Unix user, claims collide on identity | Export a distinct, stable literal `DEV_LOOP_OWNER` per agent before setup (never a $$-derived value). |
